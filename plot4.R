...
plot(data3$datetime, data3$Global_active_power, type="n", xlab="", ylab="Global Active Power")
lines(data3$datetime, data3$Global_active_power)

plot(data3$datetime, data3$Voltage, type="n", xlab="datetime", ylab="Voltage")
lines(data3$datetime, data3$Voltage)
...
plot(data3$datetime, data3$Global_reactive_power, type="n", xlab="datetime", ylab="Global_reactive_power")
lines(data3$datetime, data3$Global_reactive_power)
